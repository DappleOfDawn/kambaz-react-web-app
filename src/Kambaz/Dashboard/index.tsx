...
export default function Dashboard({
  ...
  const protectCourse = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>, enrolled: boolean) => {
    if (enrolled) {
      return;
    }
        ...
        {courses.map((course: any) => (
          <div className="wd-dashboard-course col" style={{ width: "300px" }} key={course._id}>
            <div className="card rounded-3 overflow-hidden">
              <Link onClick={(e) => protectCourse(e, course.enrolled)} to={`/Kambaz/Courses/${course._id}/Home`}
                ...
                <div className="card-body">
                  ...
                  {currentUser.role === "FACULTY" && course.enrolled && <>
